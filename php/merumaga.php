...
$site_top = "http://yukyo.co.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "kohhei@yukyo.co.jp";
...
$Referer_check_domain = "yukyo.co.jp";
...
メルマガにご登録いただきましてありがとうございます。
登録に心当たりがない方はこのメールに返信してください。
...
──────────────────────
株式会社 勇境（YuKyo,Inc.）
代表取締役  山田 耕平（Yamada Kohhei）
〒810-0001 福岡市中央区天神二丁目3番36号 ibb fukuokaビル501
TEL: (092)713-7579  FAX: (092)510-7393
MAIL: kohhei@yukyo.co.jp
──────────────────────
...
//確認画面無しの場合の表示、指定のページに移動する設定の場合、エラーチェックで問題が無ければ指定ページヘリダイレクト
	...
	if($empty_flag == 1){ ?>
<div align="center"><br /><br /><h4>入力にエラーがあります。下記をご確認の上「戻る」ボタンにて修正をお願い致します。</h4><div style="color:red"><?php echo $errm; ?></div><br /><br /><input type="button" value=" 前画面に戻る " onClick="history.back()"></div>
<?php 
